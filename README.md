...
3. Jika lebih dari 9 maka akan muncul output Herlita sampai ke 100
```sh
   else {
   System.out.println("Herlita");
}
   ```
4. Ini adalah hasil outputnya
![Screenshot (16)](https://github.com/g1a023018/Herlita.Coding/assets/149585321/17231201-5d54-4e0b-be09-f1e3bd513090)
...
```sh
   ...
   ```
4. Ini adalah hasil outputnya
![Screenshot (17)](https://github.com/g1a023018/Herlita.Coding/assets/149585321/338df888-a7d9-4609-872a-19912482ce55)
...
![Screenshot (18)](https://github.com/g1a023018/Herlita.Coding/assets/149585321/1f72629a-0d00-496c-b762-4f2d97a2001d)
...
![Screenshot (19)](https://github.com/g1a023018/Herlita.Coding/assets/149585321/fe14c640-0577-4efd-945c-5c8a4cab32dd)
